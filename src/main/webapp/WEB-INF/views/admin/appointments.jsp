<%-- Admin appointments page: review appointment status and take actions --%>
...
<div class="page-wrapper">
    ...
    <div class="main-area">
        ...
        <main class="content">
            <%-- Page header: explains the appointment management view --%>
            <div class="page-intro">
                <h1>Appointments</h1>
                <p>Review, approve, and track appointment status.</p>
            </div>

            <%-- Show status messages only when redirects provide feedback --%>
            ...
            <%-- Summary cards reflect appointment counts by status --%>
            ...
            <%-- Filter tabs update the visible rows without a page reload --%>
            ...
            <div class="card">
                <div class="table-responsive">
                    <%-- Loop through appointments provided by the controller --%>
                    <table>
                        <thead>
                        <tr>
                            <th>User</th>
