<%-- Admin reports page: present platform metrics and counselor performance --%>
...
<div class="page-wrapper">
    ...
    <div class="main-area">
        ...
        <main class="content">
            <%-- Page header: frames the reporting overview --%>
            <div class="page-intro">
                <h1>Reports</h1>
                <p>View platform insights and counselor performance metrics.</p>
            </div>

            <%-- Summary cards use controller data to highlight key platform metrics --%>
            <div class="summary-grid">
                ...
                <div class="card" style="padding:16px 20px;">
                    ...
                    <div class="mood-row"><span>&#128542; 1</span><div class="bar"><span style="width:${moodDistributionPercent['1']}%;"></span></div><span>${moodDistribution[1]}</span></div>
                    <div class="mood-row"><span>&#128577; 2</span><div class="bar"><span style="width:${moodDistributionPercent['2']}%;"></span></div><span>${moodDistribution[2]}</span></div>
                    <div class="mood-row"><span>&#128528; 3</span><div class="bar"><span style="width:${moodDistributionPercent['3']}%;"></span></div><span>${moodDistribution[3]}</span></div>
                    <div class="mood-row"><span>&#128578; 4</span><div class="bar"><span style="width:${moodDistributionPercent['4']}%;"></span></div><span>${moodDistribution[4]}</span></div>
                    <div class="mood-row"><span>&#128516; 5</span><div class="bar"><span style="width:${moodDistributionPercent['5']}%;"></span></div><span>${moodDistribution[5]}</span></div>
                </div>
                <div class="card" style="padding:16px 20px;">
                    <h3 class="summary-title">
            ...
            <%-- Use the counselor ranking list provided by the controller --%>
            <div class="card" style="padding:0;">
                <div class="card-header"><h2>Most Booked Counselors</h2></div>
                <c:set var="maxVal" value="${empty topCounselors ? 1 : topCounselors[0][1]}"/>
                <div class="table-responsive">
                    <%-- Loop through ranked counselors to render the comparison table --%>
                    <table>
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="height:8px;border-radius:999px;background:#e5e7eb;width:160px;display:inline-block;vertical-align:middle;overflow:hidden;">
                                        <div style="height:8px;border-radius:999px;background:linear-gradient(90deg,#2b7a78,#3aafa9);width:${maxVal > 0 ? ((item[1] * 100.0) / maxVal) : 0}%;"></div>
                                    </div>
            ...
            <%-- Actions here support exporting or printing the current report view --%>
            ...
            <%-- Summary modal mirrors the same metrics for a printable overview --%>
...
<%-- Keep the topbar shadow and modal state in sync with user actions --%>
<script>
