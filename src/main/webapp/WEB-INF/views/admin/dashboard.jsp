<%-- Admin dashboard: overview of key platform metrics and recent activity --%>
...
<div class="page-wrapper">
    ...
    <div class="main-area">
        ...
        <main class="content">
            <%-- Dashboard header: shows the current admin section and purpose --%>
            <div class="page-intro">
                <h1>Dashboard</h1>
                <p>Track key metrics and recent admin activity.</p>
            </div>

            <%-- Show server feedback only when dashboard loading fails --%>
            <c:if test="${not empty errorMessage}">
                <div class="error-message">${errorMessage}</div>
            </c:if>

            <%-- Summary metrics for quick admin status checks --%>
            <div class="stats-row">
                <div class="stat-card">
            ...
            <%-- Recent users table and quick stats panel for at-a-glance monitoring --%>
            <div class="main-row">
                <div class="recent-users-card">
                    <%-- Loop through the recent users provided by the controller --%>
