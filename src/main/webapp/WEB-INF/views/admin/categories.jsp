<%-- Admin categories page: organize resource groups and edit category data --%>
...
<div class="page-wrapper">
    ...
    <div class="main-area">
        ...
        <main class="content">
            <%-- Page header: clarifies category management scope --%>
            ...
            <%-- Keep the form in edit mode when a category is selected for update --%>
            <div class="admin-two-col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <%-- Preserve values while switching between create and update actions --%>
                ...
                <div class="card">
                    <div class="card-header">
                        <%-- Table title reflects the category list provided by the controller --%>
                        <h2>All Categories</h2>
                        <div class="stat-pill">${fn:length(categories)} total</div>
                    </div>
                    <div class="table-responsive">
                        <%-- Loop through categories supplied by the controller --%>
                        <table>
                            <thead>
                            <tr>
                                <th>#</th>
