<%-- Admin messages page: review inquiries and respond to users --%>
...
<div class="page-wrapper">
    ...
    <div class="main-area">
        ...
        <main class="content">
            <%-- Page header: clarifies message inbox scope --%>
            <div class="page-intro">
                <h1>Messages</h1>
                <p>View and respond to user inquiries</p>
            </div>

            <%-- Show status feedback only when a reply action returns a result --%>
            ...
            <%-- Switch between the inbox list and the reply detail view --%>
            <c:choose>
                <c:when test="${empty viewMessage}">
                    <%-- Filters update the visible inbox rows without navigation --%>
                    ...
                    <div class="table-card table-responsive">
                        <%-- Loop through messages supplied by the controller --%>
                        <table>
                            <thead>
                            <tr>
                                <th>User</th>
                ...
                <c:otherwise>
                    <%-- Detail panel keeps the selected message and reply thread in view --%>
                    <div class="detail-grid">
                        ...
                        <div class="detail-card">
                            <%-- Show the reply form only while the message is still pending --%>
...
<%-- Keep the inbox filters and topbar shadow in sync with user interaction --%>
<script>
    (function () {
