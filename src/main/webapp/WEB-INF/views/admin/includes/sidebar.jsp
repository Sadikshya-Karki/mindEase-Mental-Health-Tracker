<%-- Admin sidebar include: shared navigation for dashboard sections --%>
...
<aside class="sidebar" id="adminSidebar">
    ...
    <%-- Toggle button keeps the sidebar usable on smaller screens --%>
    ...
    <%-- Navigation links reflect the main admin sections --%>
    ...
    <%-- Logout remains separated so the session exit is easy to find --%>
...
<%-- Restore sidebar state and highlight the current admin route --%>
<script>
    (function () {
