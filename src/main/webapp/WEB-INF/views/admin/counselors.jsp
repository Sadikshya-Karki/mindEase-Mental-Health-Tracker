<%-- Admin counselors page: manage counselor profiles and availability --%>
...
<div class="page-wrapper">
    ...
    <div class="main-area">
        ...
        <main class="content">
            <%-- Page header: clarifies counselor management scope --%>
            ...
            <%-- Keep the form in edit mode when a counselor is selected for update --%>
            <div class="admin-two-col-wide">
                ...
                <div class="card">
                    <div class="card-header">
                        <%-- Table title reflects the counselor list provided by the controller --%>
                        <h2>All Counselors</h2>
                    </div>
                    <div class="table-responsive">
                        <%-- Loop through counselors supplied by the controller --%>
