<%-- Book appointment page: counselor selection and session scheduling --%>
...
<div class="user-layout">
    ...
    <div class="user-main">
        ...
        <main class="user-content content">
            ...
            <%-- Error alert: shown if appointment booking fails --%>
            ...
            <div class="two-column-grid">
                <div>
                    <%-- Counselors grid: iterate through available counselors from controller --%>
                ...
                <div>
                    <div class="booking-card" id="bookingCard">
                        <%-- No selection message: shown initially until counselor is selected --%>
