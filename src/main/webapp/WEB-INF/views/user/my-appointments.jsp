<%-- My appointments page: view user's booked appointments and their status --%>
...
<head>
    ...
    <style>
        ...
        .stat-filter-card.active { background: white; border-color: #f1f5f9; box-shadow: 0 2px 10px rgba(43,122,120,0.08); }
        ...
        @media (max-width: 640px) {
            ...
            .stat-filter-card { padding: 14px; gap: 12px; }
            .stat-filter-number { font-size: 1.35rem; }
        }
    </style>
</head>
<body>
<div class="user-layout">
    ...
    <div class="user-main">
        ...
        <main class="user-content content">
            ...
            <%-- Appointment statistics cards: total, approved, pending, rejected --%>
