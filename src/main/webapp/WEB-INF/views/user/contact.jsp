<%-- Contact support page: send messages to support team and manage history --%>
...
<head>
    ...
    <style>
        .contact-page { max-width: 1280px; margin: 0 auto; padding: 0; }
		...
		.contact-right { position: sticky; top: 20px; justify-self: end; width: 100%; max-width: 320px; }
        ...
        @media (max-width: 1024px) {
			...
			.contact-right { position: static; max-width: none; justify-self: stretch; }
		}
    </style>
</head>
<body>
                ...
                <div class="contact-left">
                    <div class="contact-card">
                        ...
                        <form method="post" action="${ctx}/user/contact" id="contactForm">
                            <%-- Contact form fields: pre-filled name, category dropdown, subject, message --%>
