<%-- Welcome banner component: personalized greeting and key stats --%>
...
<section class="welcome-banner">
    ...
    <%-- Date, personalized greeting, and motivational message --%>
    ...
    <%-- Quick stat cards: current streak, today's mood, average score --%>
