<%-- Quick mood log widget: fast mood entry with inline buttons and optional note --%>
...
<section class="mood-widget" id="quick-mood-log">
    ...
    <%-- Inline mood entry form: score buttons + optional note textarea --%>
    <form id="moodLogForm" method="post" action="${pageContext.request.contextPath}/user/log-mood">
        ...
        <%-- Mood buttons: 1-5 scale with emojis for quick selection --%>
