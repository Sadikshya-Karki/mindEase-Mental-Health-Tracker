<%-- Browse resources page: search, filter, and explore wellness content --%>
...
<head>
    ...
    <style>
        ...
        .hero-banner h1 { color: white; font-size: 1.5rem; font-family: Poppins,'Segoe UI',sans-serif; margin-bottom: 8px; }
        .hero-banner p  { color: rgba(255,255,255,0.70); margin-bottom: 16px; font-size: 0.9rem; }

        .search-container {
            display: flex; align-items: center;
            background: rgba(255,255,255,0.15);
            border: 1px solid rgba(255,255,255,0.25);
            border-radius: 60px; padding: 4px 14px; max-width: 420px;
        }
        .search-input { background: transparent; border: none; padding: 8px 0; color: white; font-size: 0.9rem; width: 100%; outline: none; }
        ...
        <main class="user-content content">
            ...
            <div class="hero-banner">
                ...
                <div class="hero-content">
                    ...
                    <%-- Search input: find resources by title, author, or keyword --%>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-meta">
                                        <span class="category-badge"
                                              ...
                                              data-category="${safeCategoryName}">
                                            ${safeCategoryName}
                                        </span>
