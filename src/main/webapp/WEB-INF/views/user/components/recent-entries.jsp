<%-- Recent mood entries component: display latest mood logs --%>
...
<section class="sidebar-card">
    ...
    <%-- Empty state: shown if no mood entries exist --%>
    <c:choose>
        <c:when test="${empty recentEntries}">
            <p class="empty-text">No mood entries yet. Log your first mood above.</p>
        </c:when>
        <%-- Loop through recent entries: display emoji, score label, date, note snippet, tags --%>
        <c:otherwise>
