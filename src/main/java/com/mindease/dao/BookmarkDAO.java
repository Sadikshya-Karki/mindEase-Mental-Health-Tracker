...
/**
 * Data access operations for user bookmarks on resources.
 */
public class BookmarkDAO {

    /**
     * Counts bookmarked resources for a user.
     *
     * @param userId user id
     * @return bookmark count, or {@code 0} on failure
     */
    ...
    /**
     * Returns a limited list of published resources bookmarked by a user.
     *
     * @param userId user id
     * @param limit maximum number of resources
     * @return bookmarked resources, or an empty list on failure
     */
    ...
    /**
     * Gets bookmarked resource ids for a user.
     *
     * @param userId user id
     * @return resource ids, or an empty list on failure
     */
    ...
    /**
     * Gets detailed bookmarked published resources for a user.
     *
     * @param userId user id
     * @return bookmarked resources, or an empty list on failure
     */
    ...
    /**
     * Adds a bookmark for a resource.
     *
     * @param userId user id
     * @param resourceId resource id
     * @return {@code true} if insert executes successfully
     */
    ...
    /**
     * Removes a bookmark for a resource.
     *
     * @param userId user id
     * @param resourceId resource id
     * @return {@code true} if delete executes successfully
     */
