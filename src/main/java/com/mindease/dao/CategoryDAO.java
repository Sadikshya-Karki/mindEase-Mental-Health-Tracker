...
/**
 * Data access operations for resource categories.
 */
public class CategoryDAO {

    /**
     * Retrieves all categories ordered by newest first.
     *
     * @return category list, or an empty list on failure
     */
     ...
     * @return matching category, or {@code null} if not found or on failure
     */
